...
module.exports = class tskmgr1674479566344 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TYPE "public"."task_priority_enum" AS ENUM('NEWEST', 'OLDEST', 'LONGEST', 'SHORTEST')`);
        await queryRunner.query(`CREATE TABLE "task" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "type" character varying NOT NULL, "command" character varying NOT NULL, "arguments" text, "options" jsonb, "runner_id" character varying, "runner_info" jsonb, "status" "public"."task_status_enum" NOT NULL DEFAULT 'PENDING', "cached" boolean, "duration" real, "avg_duration" real, "priority" "public"."task_priority_enum" NOT NULL DEFAULT 'LONGEST', "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "started_at" TIMESTAMP WITH TIME ZONE, "ended_at" TIMESTAMP WITH TIME ZONE, "run_id" integer NOT NULL, CONSTRAINT "PK_fb213f79ee45060ba925ecd576e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_36326cc52f4708f36ae4e6158c" ON "task" ("run_id") `);
        await queryRunner.query(`CREATE TYPE "public"."run_status_enum" AS ENUM('CREATED', 'STARTED', 'ABORTED', 'FAILED', 'COMPLETED')`);
        await queryRunner.query(`CREATE TABLE "run" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "type" character varying NOT NULL, "closed" boolean NOT NULL DEFAULT false, "url" character varying, "fail_fast" boolean NOT NULL DEFAULT true, "leader_id" character varying, "prioritization" text NOT NULL DEFAULT 'LONGEST', "info" jsonb, "parameters" jsonb, "affinity" boolean NOT NULL DEFAULT false, "duration" real, "status" "public"."run_status_enum" NOT NULL DEFAULT 'CREATED', "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "ended_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "UQ_cc57fcee07868cfdd728d9ac17e" UNIQUE ("name"), CONSTRAINT "PK_804c38ffba92002c6d2c646dd46" PRIMARY KEY ("id"))`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_8d6894434dbc389d6047dc1cc7"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_2d682198c6b8ebcf0539273ba0"`);
        await queryRunner.query(`DROP TABLE "file"`);
        await queryRunner.query(`DROP TABLE "run"`);
        await queryRunner.query(`DROP TYPE "public"."run_status_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_36326cc52f4708f36ae4e6158c"`);
